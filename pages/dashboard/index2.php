                        ...
                        <div class="card-body">
                            <div class="row">
                                ...
                                <div class="col-8">
                                    ...
                                    <span class="info-box-number text-white">145</span>
                                </div>
                            </div>
                        </div>
                    </div>
                    ...
                    <div class="card card-custom bg-info">
                        <div class="card-body">
                            <div class="row">
                                ...
                                <div class="col-8">
                                    <span class="info-box-text text-white">Pasien Belum Diperiksa Hari ini :</span>
                    ...
                    <div class="card card-custom bg-info">
                        <div class="card-body">
                            ...
                            <ul class="list-unstyled">
                                <li class="text-white">09:45 - Pasien: Boby</li>
                                <li class="text-white">13:30 - Pasien: Agus</li>
                                <!-- Lainnya... -->
                            </ul>
                        </div>
                    </div>
                ...
                <div class="col-12 col-md-6">
                    <div class="card card-custom bg-danger">
                        <div class="card-body">
                            ...
                            <p class="text-white">Pasien Dengan Kasus Kritis: Pardi (Ruangan 305)</p>
                            <!-- Lainnya... -->
                        </div>
                    </div>
                </div>
